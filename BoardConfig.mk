...
#erofs specific settings
BOARD_EROFS_COMPRESSOR := lz4
BOARD_EROFS_PCLUSTER_SIZE := 65536
BOARD_EROFS_USE_ZTAILPACKING := true
BOARD_EROFS_USE_LEGACY_COMPRESSION := false
EROFS_MKFS_EXTRA_ARGS := -T0 -C65536 -Eforce-inode-compact,all-fragments 
BOARD_EROFS_USE_DEDUPE := true
